...
export async function POST(request: Request) {
  try {
    ...
    // Override for Housing Loans as they are exempt from BSMV and KKDF
    loanData.bsmv = 0;
    loanData.kkdf = 0;
    ...
    return NextResponse.json({ message: 'Housing loan created successfully' }, { status: 201 });
  } catch (error: any) {
    return NextResponse.json({ error: error.message }, { status: 500 });
  }
}

// PUT (update) a housing loan
export async function PUT(request: Request) {
    try {
      ...
      // Remove the 'banks' object before updating
      ...
      return NextResponse.json({ message: 'Housing loan updated successfully' });
    } catch (error: any) {
      return NextResponse.json({ error: error.message }, { status: 500 });
    }
  }

// DELETE a housing loan
export async function DELETE(request: Request) {
    try {
        ...
        return NextResponse.json({ message: 'Housing loan deleted successfully' });
    } catch (error: any) {
        return NextResponse.json({ error: error.message }, { status: 500 });
    }
}
